...
/**
 * Created by kys-34 on 2018/10/27.
 */
     ...
     */
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (widthMode == MeasureSpec.EXACTLY) {
                ...
                isWrapContent=true;
                mWidth=(int)(textPaint.measureText("0")*1.5*codeNum+20+ DpUtil.vDpToPx(getContext(),8));
            }
            ...
            if (heightMode == MeasureSpec.EXACTLY) {
                ...
                mHeight= (int) DpUtil.vDpToPx(getContext(),40);
            }
        ...
        private void initView() {
            ...
            maxTextSize=DpUtil.spToPx(getContext(),50);
            defaultTextSize=DpUtil.spToPx(getContext(),22);
            textPaint=new Paint();
        ...
        private void createCodeBitmap() {
            ...
            if (!isWrapContent){
                ...
                horizontalOffset= (int) ((mWidth-drawWidth-DpUtil.vDpToPx(getContext(),8))/2);
        ...
        private void dynamicSetTextPaint(String text){
            int avaiWidth = (int) (mWidth*2.0f/3 - getPaddingLeft() - getPaddingRight() - DpUtil.vDpToPx(getContext(), 2));
            if (avaiWidth <= 0) {
                return;
            }
